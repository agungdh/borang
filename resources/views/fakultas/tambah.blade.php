...
<div class="row">
  <div class="col-md-12">
    <div class="tile">
      ...
      <div class="tile-body">
        <form method="post" action="{{ action('FakultasController@store') }}">
          @csrf

          <div class="form-group">
            <label class="control-label">Nama Fakultas</label>
            <input class="form-control" type="text" required placeholder="Masukan Nama Fakultas" name="data[nama_fakultas]">
          </div>
